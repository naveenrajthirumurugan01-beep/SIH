    ...
    return OfflineInspectionDraft(
      ...
      observation: json['observation'] != null
          ? FieldObservation(
              inspectionId: json['inspection_id'] as String? ?? '',
              officerUid: json['officer_uid'] as String? ?? '',
              crack: CrackStatusX.fromFirestoreValue(
                  json['observation']['crack'] as String? ?? 'none'),
              slopeMovement: SlopeMovementX.fromFirestoreValue(
                  json['observation']['slope_movement'] as String? ?? 'none'),
              rockfall: json['observation']['rockfall'] as bool? ?? false,
              waterSeepage: json['observation']['water_seepage'] as bool? ?? false,
              roadCondition: RoadConditionX.fromFirestoreValue(
                  json['observation']['road_condition'] as String? ?? 'normal'),
              overallObservation: OverallObservationX.fromFirestoreValue(
                  json['observation']['overall_observation'] as String? ?? 'safe'),
              remarks: json['observation']['remarks'] as String? ?? '',
              recordedAt: DateTime.tryParse(
                      json['observation']['recorded_at'] as String? ?? '') ??
                  DateTime.now(),
            )
          : null,
