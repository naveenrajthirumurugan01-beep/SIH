...
class FieldOfficerDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Retrieve authenticated officer profile details
    final profile = authProvider.profile;
    final officerName = profile?.fullName ?? appState.officerName ?? 'Officer Tashi Rabha';
    final officerId = profile?.officerId ?? appState.officerId ?? 'OFFICER-DV-001';
    final officerUid = profile?.uid ?? appState.officerId ?? demoOfficerUid;
    final accountStatus = profile?.status.toUpperCase() ?? 'ACTIVE';

    return Scaffold(
      appBar: AppBar(
        title: const Text('Field Operational Dashboard'),
        actions: [
          IconButton(
              ...
              return ListView(
                ...
                children: [
                  ...
                  _buildOfficerHeaderCard(
                    ...
                    district: profile?.district ?? 'Dibang Valley',
                  ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        'Status: Active — On Duty ($accountStatus)',
