    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _FactorBadge(label: 'Slope', value: zone.slopeFactor),
              const SizedBox(width: 6),
              _FactorBadge(label: 'Rainfall', value: zone.rainfallFactor),
              const SizedBox(width: 6),
              _FactorBadge(label: 'Soil Moisture', value: zone.soilMoistureFactor),
              const SizedBox(width: 6),
              _FactorBadge(label: 'History', value: zone.historyFactor),
            ],
          ),
          const SizedBox(height: 14),
